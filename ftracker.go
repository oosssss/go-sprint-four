...
func RunningSpentCalories(action int, weight, duration float64) float64 {
    ...
    runSpentCalories := (runningCaloriesMeanSpeedMultiplier * speed * runningCaloriesMeanSpeedShift) * weight / mInKm * duration * minInH
...
func WalkingSpentCalories(action int, duration, weight, height float64) float64 {
    ...
    walkSpentCalories := (walkingCaloriesWeightMultiplier * weight + (math.Pow(speed, 2) / heightInM) * walkingSpeedHeightMultiplier * weight) * duration * minInH
...
func SwimmingSpentCalories(lengthPool, countPool int, duration, weight float64) float64 {
    ...
    swimSpentColories := (speed + swimmingCaloriesMeanSpeedShift) * 2 * weight * duration
    return swimSpentColories
}
